...
check was introduced: **43 findings across 8 files
and 2,252 lines**. CI compares against that budget and fails only when a
...
|---|---:|---|---|---|
| `RS001` | 12 | warn | immutable values | mutable local binding (`let mut`) |
...
*immutable values* · 12 occurrences at baseline
